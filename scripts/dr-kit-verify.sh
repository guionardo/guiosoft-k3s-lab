...
required=(dr-target-init.sh dr-network-isolation.sh dr-preflight.sh dr-restore-k3s.sh k3s-backup-verify.sh dr-pv-import.sh dr-pv-remap.sh dr-oci-preload.sh)
