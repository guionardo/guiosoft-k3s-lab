...
LOCK_FILE="${K3S_CONSISTENT_BACKUP_LOCK_FILE:-/run/lock/guiosoft-k3s-consistent-backup.lock}"
...
exec 9>"$LOCK_FILE"
flock -n 9 || { echo "error: another consistent backup is already running" >&2; exit 75; }
